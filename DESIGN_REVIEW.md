...
- Fix: Consolidate to a declared scale (e.g. 9, 10, 11, 12(xs), 13, 14(sm), 15, 16(base), 22, 27, 34, 40/44, 54) as @theme font-size tokens; delete the half-pixel sizes (12.5→13 or 12, 13.5→13 or 14, 14.5→14, 11.5→11, 10.5→10 or 11, 9.5→9 or 10) and replace `text-[12px]`→`text-xs`. One mechanical sweep, big perceived-quality payoff. Landed scale (design-polish 2026-07-10): 9 · 10 · 11 · xs(12) · 13 · sm(14) · 15 · base(16) · lg(18) · xl(20) · 22 · 2xl(24) · 26 · 3xl(30) · 34 · 4xl(36) · 40 · 44 · 54 — all half-pixel steps deleted (9.5→10, 10.5→11, 11.5→11, 12.5→13, 13.5→sm where body-level, 14.5→sm), 8→9, 12→xs, login lockup 17→base/21→lg, loading h3s 27→26, quiz h1 27/31→26/3xl; consciously kept arbitrary steps: 9/10/11/13/15 (micro-UI) and display 22/26/34/40/44/54.
